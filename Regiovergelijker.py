...
if radio_nav == 'Home':
    ...
    st.sidebar.markdown('''Tenzij anders vermeld is alles in dit werk gelicenceerd onder een [Creative Commons BY-NC-SA 4.0-licentie](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.nl). Wanneer u gebruik wilt maken van dit werk, hanteer dan de volgende methode van naamsvermelding: 
